...
import 'package:previsaotempo/models/weather.dart';
import 'package:previsaotempo/screens/home/widgets/weather.dart';
import 'package:previsaotempo/screens/shared/find_icon.dart';
...
class MainScreen extends StatelessWidget {
  ...
  Widget builder(BuildContext context, int index) {
    Weather weather = Weather(
      ...
      icon: findIcon(
        this.data["forecast"][index]["condition"],
      ),
